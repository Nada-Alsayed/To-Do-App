...
-(void)viewWillAppear:(BOOL)animated{
    ...
    NSData *saveData=[defaults objectForKey:@"InProgArr"];
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        if(self->_isFiltered)
        {
            ...
            [defaultData setObject:newArchiveData forKey:@"InProgArr"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
     TableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cellb" forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath {
    ...
    EditInProgressViewController *addScreen=[self.storyboard instantiateViewControllerWithIdentifier:@"editInProgress"];
